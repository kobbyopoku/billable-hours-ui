...
<body id="page-top">
    ...
    <div id="preloader">
        <div class="canvas">
            <img src="assets/img/vodafone.png" alt="Ananse - vodafone ghana" class="loader-logo">
            ...
            <div class="w3-card-2 w3-white panel default-sidebar">
                ...
                <nav class="side-navbar box-scroll sidebar-scroll">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="base.php"><i class="la la-home"></i><span>Dashboard</span></a></li>
                        <!-- <li><a href="#" class="active"><i class="ion-filing"></i><span>Base view</span></a></li> -->
                        <li><a href="performance.php"><i class="ti-stats-up"></i><span>Performance View</span></a></li>
                        <li><a href="team-ranking.php"><i class="ti-bar-chart"></i><span>Team Ranking</span></a></li>
                        <li><a href="#dropdown-interactions" aria-expanded="false" data-toggle="collapse"><i class="ti-agenda"></i><span>Interactions</span></a>
                            <ul id="dropdown-interactions" class="collapse list-unstyled pt-0">
                                <li><a href="interactions-by-subscriber.php">By Subscriber</a></li>
                                <li><a href="interactions-by-date-range.php">By Date Range</a></li>
                            </ul>
                        </li>
                        <li><a href="#dropdown-tables" aria-expanded="true" data-toggle="collapse" class="active"><i class="ti-settings"></i><span>Settings</span></a>
                            <ul id="dropdown-tables" class="list-unstyled pt-0">
                                <li><a href="users.php" class="sub_active">Users</a></li>
...
<!--<span class="heading">Title</span>-->
                        ...
                        <div class="col-xl-12">
                            <div id="handleErrorMessages">
                                <div class="row" align="center">
                                    ...
                                    <div class="col-md-2">
                                        <p><button type="button" class="btn btn-danger btn-gradient-01 waves-effect waves-light" id="retryBtn">Retry</button></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="w3-card-2 w3-white panel widget has-shadow">
                                <div class="widget-header bordered no-actions">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <h4><a href="#" id="manageCustomersBtn" class="btn btn-danger outline-btn pull-right m-l-20 waves-effect waves-light">Manage Customers</a></h4>
                                        </div>
                                        <div class="col-md-2">
                ...
                <footer class="main-footer fixed-footer">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-xl-start justify-content-lg-start justify-content-md-start justify-content-center">
                            <p class="text-gradient-02">Powered by <b>vodafone</b></p>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select-roletype form-control" id="addRoletype" name="addRoletype">
                                            ...
                                            <option value="Super Admin">LAWYER</option>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger btn-gradient-01 waves-effect waves-light" id="addUserBtn">Add User</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <label><p id="showAdminFullname"></p></label>
                            </div>
                        </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <label><p id="showAdminUsername"></p></label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <label><p id="showAdminRole"></p></label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <label><p id="showAdminStatus"></p></label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <label><p id="showAdminCreatedBy"></p></label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <label><p id="showAdminCreatedDate"></p></label>
                            </div>
                        </div>
        ...
        <div id="assignCustomersModal" class="modal modal-xl fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Assign Customers</h4> 
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                        ...
                        <form id="assignCustomersForm">
                            <div class="form-group row d-flex align-items-center mb-5">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <select class="custom-select-agentType form-control" id="selectAgentType" name="selectAgentType" data-live-search="true">
                                ...
                                <div class="col-md-12">
                                    <label class="form-control-label">Customer Badge Label</label>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="ti-id-badge"></i>
                                            </span>
                                            <input type="text" class="form-control" id="customerBadgeLabel" placeholder="Enter a label for this badge">
                                        </div>
                                    </div>
                                </div>

                                <div class="col-md-12">
                                    <label class="form-control-label">Customer File (<span style="color:#E00021;">CSV format only</span>)</label>
                                    <div class="form-group">
                                        <input type="file" class="form-control" id="dealCsv" accept=".csv"/>
                                    </div>
                                </div>
                                ...
                                <!--   <div class="col-md-12">
                                      ...
                                      <div class="form-group">
                                          <select class="selectpicker custom-select-selectCustomers form-control" id="selectCustomers" name="selectCustomers" multiple="multiple" data-live-search="true">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-danger btn-gradient-01 waves-effect waves-light" id="assignCustomersBtn">Assign Customers</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="deleteCustomersModal" class="modal modal-xl fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-danger btn-gradient-01 waves-effect waves-light" id="deleteCustomersBtn">Delete Customers</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="editUserModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-danger btn-gradient-01 waves-effect waves-light" id="editUserBtn">Edit User</button>
                    </div>
                </div>
            </div>
        </div>
