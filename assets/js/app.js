...
var getCompanyInvoice = baseUrl + apiRoute + "invoice/generate/";
...
$(document).on('click', '[data-invoice-details]', function (e) {
    ...
    for (i = 0; i < allData.length; i++) {
        ...
        table_list +=
            "<tr>" +
            "<td style='width: 10%'>" + mainData.employee.id + "</td>" +
            "<td style='width: 30%'>" + mainData.numberOfHours + "</td>" +
            "<td style='width: 10%'>" + mainData.unitPrice + "</td>" +
            "<td style='width: 10%'>" + mainData.cost + "</td>" +
            "</tr>"
    ...
    var tabletotal = '<tr>' +
        ...
        '<th style="width: 10%">' + jsonDetails.totalAmount + '</th>' +
        '</tr>';

    $('#invoiceTableData').html((table_list)).append(tabletotal);
