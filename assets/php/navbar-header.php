...
<header class="header">
    <nav class="navbar fixed-top">         
        ...
        <div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
            ...
            <div class="navbar-header">
                <a href="" class="navbar-brand">
                    ...
                    <div class="brand-image brand-small">
                        <img src="assets/img/logo-big.png" alt="logo" class="logo-small">
                    </div>
                </a>
                <!-- Toggle Button -->
            ...
            <!-- End Logo -->
            <!-- Begin Navbar Menu -->
            <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right"><h6 class="page-header-title"><span id="showUsername"></span></h6>
                <!-- Search -->
                <!-- End Search -->
                <!-- Begin Notifications -->
